...
export default function MasajeReservationDetail() {
  ...
  const handleStatusChange = async (newStatus) => {
    ...
    try {
      const updatedReservation = await updateMasajeReservation(id, { estado: newStatus });
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {formatDateTime(reservation.hora)}
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{reservation.duracion} minutos</p>
                  </div>
                </div>
                {reservation.terapeuta && (
                  <div className="flex items-start gap-3">
                    <FaUserFriends className="text-gray-500 mt-1" />
                    <div>
                      <p className="text-sm text-gray-500">Terapeuta</p>
                      <p className="font-medium">{reservation.terapeuta}</p>
                    </div>
                  </div>
                )}
            ...
            <div>
              ...
              <div className="mt-4 space-y-2">
                <div className="flex justify-between">
                  ...
                  <span>${reservation.precio.toLocaleString('es-MX')}</span>
                </div>
                ...
                <div className="flex justify-between font-bold border-t border-gray-200 pt-2 mt-2">
                  <span>Total:</span>
                  <span>${reservation.total ? reservation.total.toLocaleString('es-MX') : reservation.precio.toLocaleString('es-MX')}</span>
                </div>
              </div>
            </div>
          </div>

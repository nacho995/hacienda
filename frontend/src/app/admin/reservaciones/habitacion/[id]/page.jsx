...
import { getHabitacionReservation, updateHabitacionReservation, deleteHabitacionReservation } from '@/services/reservationService';
import { FaArrowLeft, FaSpinner, FaCalendarAlt, FaUserFriends, FaBed, FaMoneyBillWave, FaEnvelope, FaPhone, FaClock, FaRuler } from 'react-icons/fa';
...
export default function HabitacionReservationDetail({ params }) {
  ...
  const handleStatusChange = async (newStatus) => {
    ...
    try {
      const response = await updateHabitacionReservation(id, { estado: newStatus });
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{reservation.numHuespedes || 'No especificado'}</p>
                  </div>
                </div>
              </div>
            </div>

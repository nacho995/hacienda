...
const carouselData = [
  {
    ...
    heading: '<span style="color: #FFFFFF; font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">El</span> <span style="color: var(--color-brown-medium); font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">ARTE DE CELEBRAR</span>',
    secondHeading: '<span style="color: #FFFFFF; font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">Momentos</span> <span style="color: var(--color-brown-medium); font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">INOLVIDABLES</span>',
  ...
  },
  {
    ...
    heading: '<span style="color: var(--color-brown-medium); font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">ESPACIOS</span> <span style="color: var(--color-brown-medium); font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">ÚNICOS</span>',
    secondHeading: '<span style="color: #FFFFFF; font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">Para</span> <span style="color: var(--color-brown-medium); font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">CADA</span> <span style="color: #FFFFFF; font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">Ocasión</span>',
  ...
  },
  {
    ...
    heading: '<span style="color: var(--color-brown-medium); font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">TRADICIÓN</span> <span style="color: #FFFFFF; font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">Y</span> <span style="color: #FFFFFF; font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">ELEGANCIA</span>',
    secondHeading: '<span style="color: #FFFFFF; font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">En</span> <span style="color: var(--color-brown-medium); font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">CADA DETALLE</span>',
  ...
  },
  {
    ...
    heading: '<span style="color: var(--color-brown-medium); font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">CELEBRACIONES</span> <span style="color: #FFFFFF; font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">Familiares</span>',
    secondHeading: '<span style="color: var(--color-brown-medium); font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">MEMORABLES</span>',
                ...
                <div className="relative z-10 transform -translate-y-20">
                  ...
                  {slide.heading && (
                    <div className="relative z-10">
                      <div className="relative transform-style-preserve-3d">
                        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight tracking-tight inline-block transform-style-preserve-3d text-white font-script">
                  ...
                  {slide.secondHeading && (
                    <div className="relative z-10 mt-4">
                      <div className="relative transform-style-preserve-3d">
                        <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl xl:text-5xl leading-tight tracking-tight inline-block transform-style-preserve-3d text-white font-script">
                          <span dangerouslySetInnerHTML={{ __html: slide.secondHeading }} />
                        </h2>
                        <div className="absolute inset-0 filter blur-[8px] bg-[var(--color-brown-medium)]/20 -z-10" style={{ clipPath: 'inset(-15px -25px -35px -25px round 16px)' }}></div>
                      </div>
                    </div>

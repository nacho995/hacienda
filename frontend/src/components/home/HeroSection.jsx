...
const carouselData = [
  ...
  },
  {
    ...
    heading: '<span style="font-family: \'Trajan Pro\', \'Cinzel\', \'Didot\', serif; color: var(--color-brown-medium); font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">EVENTOS</span> <span style="font-family: \'Trajan Pro\', \'Cinzel\', \'Didot\', serif; color: var(--color-brown-medium); font-weight: 900; text-shadow: 0px 0px 3px rgba(0,0,0,0.9), 0px 0px 6px rgba(0,0,0,0.7), 2px 2px 0px var(--color-brown-dark), -1px -1px 0px var(--color-brown-light); transform: translateZ(20px); display: inline-block;">CORPORATIVOS</span>',
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
                ...
                <div className="relative z-10 transform -translate-y-20">
                  ...
                  <div className="mt-8">
                    <Link
                      href={slide.cta === 'Conocer Más' ? '/' : slide.cta === 'Ver Bodas' ? '/eventos' : slide.cta === 'Espacios' ? '/habitaciones' : slide.cta === 'Galería' ? '/galeria' : '/contacto'}

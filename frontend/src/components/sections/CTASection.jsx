          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className={`transition-all duration-1000 transform ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-[-50px] opacity-0'}`}>
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-[var(--font-display)] font-light text-white mb-8 leading-tight">
                  Haz Realidad <span className="font-semibold text-[var(--color-primary)]">El Evento</span> De Tus Sueños
                </h2>
                ...
                <p className="text-xl text-white/90 font-light mb-10 leading-relaxed">
                  Desde bodas de ensueño hasta eventos corporativos excepcionales, 
                  ponemos a tu disposición un lugar con historia, elegancia y servicio 
                  de clase mundial para crear momentos inolvidables.
                </p>
                
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 mb-12">
                  <div className="flex items-center space-x-4">
                    <div className="w-14 h-14 rounded-full bg-[var(--color-primary)] flex items-center justify-center text-white">
                      <FaCalendarAlt className="w-6 h-6" />
                    </div>
                    <div>
                      <h3 className="text-white font-medium text-lg">Agenda una visita</h3>
                      <p className="text-white/80 text-sm">Conoce nuestras instalaciones</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-white font-medium text-lg">Años de experiencia</h3>
                      <p className="text-white/80 text-sm">Creando eventos inolvidables</p>
                    </div>
                  </div>
                </div>

        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="max-width: 600px; margin: 0 auto; background-color: #FFFFFF; border: 1px solid #E0D8CC; border-radius: 8px; overflow: hidden;" class="email-container">
          ...
          <tr>
            <td style="padding: 30px; color: #4E3629; font-size: 16px; line-height: 1.6;" class="content">
              <h1 style="color: #800020; font-family: Didot, Georgia, 'Times New Roman', serif; font-size: 24px; margin-top: 0; margin-bottom: 20px; font-weight: normal; text-align: center;">Contraseña Restablecida Exitosamente</h1>
              <p>Hola ${nombreUsuario || 'Usuario'},</p>
              <p>Le confirmamos que la contraseña de su cuenta en Hacienda San Carlos Borromeo ha sido restablecida correctamente.</p>
              <p>Ahora puede iniciar sesión utilizando su nueva contraseña.</p>
